  ...
  <main>
    <section class="authenticate">
      <header class="row titlebar">
        ...
        <Icon v-if="!darkmode" icon="tabler:sun" :title="t('pages.auth.dark_mode_switch_title')" class="darkmode"
          @click="toggleDark" />
        <Icon v-if="darkmode" icon="tabler:moon" :title="t('pages.auth.dark_mode_switch_title')" class="darkmode"
          @click="toggleDark" />
      </header>
      ...
      <div class="row signup_or_signin">
        <article class="column signup">
          ...
          <form @submit.prevent="signUp">
            <div class="input-group">
              <input type="text" v-model="username" :placeholder="t('pages.auth.signup.username_placeholder')"
                id="signup-username" required>
            </div>
            <div class="input-group">
              <input type="text" v-model="name" :placeholder="t('pages.auth.signup.fullname_placeholder')"
        ...
        <article class="column signin">
          ...
          <form @submit.prevent="signIn">
            <div class="input-group">
              <input type="text" v-model="username" :placeholder="t('pages.auth.signin.username_placeholder')"
                id="signin-username" required>
            </div>
